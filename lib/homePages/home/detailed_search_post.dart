...
class DetailedSearchPost extends StatefulWidget {
  final Post postInfo;
  final bool needPopComment;
  final String backTo;
  final int myAccountId;
  final SearchPostNotifier postNotifier;
  const DetailedSearchPost({
    super.key,
  ...
  @override
  State<DetailedSearchPost> createState() => _DetailedSearchPostState();
}

class _DetailedSearchPostState extends State<DetailedSearchPost> {
